...
def accessible_course_video_ids(
    ...
    An entitled student (subscribed or enrolled) or the owning doctor may use
    every video in the course. A student who reached the opened video only because it is a preview
